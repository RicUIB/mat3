...
$$
P(\mbox{``dos multiplos de 3"} )=\frac{CF}{CP}=\frac{{{6}\choose{2}}\cdot{{20-6}\choose {3}}}{{{20}\choose{5}}}=\frac{`r choose(6,2)*choose(10-6,2)`}{ `r choose(20,5)`}.=`r  choose(6,2)* choose(20-6,3)/choose(20,5)`.
$$
