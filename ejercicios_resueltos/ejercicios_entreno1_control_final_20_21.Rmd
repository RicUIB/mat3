...
\frac{10^y\cdot \log_{e}(10)}{9} & \mbox{si } 0< y < 1\\
0 & \mbox{en cualquier otro caso}\\
\end{array}\right.
$$
...
$$F_y(y_0)=\frac{10^{y_0}log_{e}(10)-1}{9}=0.95$$

así que $10^{y_0}=\frac{9\cdot 0.95+1}{\log_{e}(10)}=`r (9*0.95+1)/log(10)`$, de donde $y_0=\log_{10}\left(\frac{9\cdot 0.95+1}{\log_{e}(10)}\right)=\log_{10}(`r (9*0.95+1)/log(10)`)=`r log10((9*0.95+1)/log10(10))`.$
