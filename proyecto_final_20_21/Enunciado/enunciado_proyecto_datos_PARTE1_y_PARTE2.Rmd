---
title: "Proyecto asignatura  Estadística (MAT3) GIN2 Grupos 1 y 3: PARTE 1 y PARTE 2"
...
# Parte 1: Estadística Descriptiva (1 punto sobre 10 de la nota final. Entregad por  Aula Digital antes del 21 de abril)

La proyecto  se entrega en  **grupos de 4 persones**. Cada grupo tendrá asignado un **nombre de ciudad** 
que podréis consultar en la página de la asignatura en Aula Digital.
La práctica consiste en obtener los datos de la ciudad asignada, correspondientes a **febrero de 2020**, de la [web de Airbnb](http://insideairbnb.com/get-the-data.html) y redactar un informe utilizando  Rmarkdown respondiendo a las 
...
Todas las preguntas se pueden contestar a partir de la información de los manuales de [AprendeR1](https://aprender-uib.github.io/AprendeR1/) y [AprendeR2](https://aprender-uib.github.io/AprendeR2/) [ApredeR2 tema 8](https://aprender-uib.github.io/AprendeR2/chap-estmult.html), a parte de los enlaces proporcionados en este documento, y, en general, haciendo búsquedas en internet.
