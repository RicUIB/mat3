...
$$P(A)=P(A|B)\cdot P(B)+P(A|B^c)\cdot P(B^c)=0.4\cdot (1-0.2)+ 0.5\cdot 0.2=\Sexpr{r1}.$$
...
Ahora $X$ número de veces que hay que tirar los 10 dados hasta obtenr una tirada con exactamente 5 cincos ("éxito")  claramente es la repetición de un experimento $Ber(p=\Sexpr{ dbinom(5,size=10,prob=1/6)})$  luego $X$ sigue una ley $Ge(p=P(Y=5)=\Sexpr{ dbinom(5,size=10,prob=1/6)}).$
...
<<p31,echo=FALSE>>=
r1=dbinom(0,size=20,prob=1-0.75)
r2=pbinom(2,size=20,prob=0.75)
r3=pbinom(4,size=20,prob=0.75)
@

$$P(\mbox{ningún cliente entre los 20 vea el anuncio})=P(X=0)=\Sexpr{ r1}.$$

lo hemos calculado con R

<<p31_2>>=
dbinom(0,size=20,prob=1-0.75)
@
