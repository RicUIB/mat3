...
datos_o$club[1:10]
club6 = unique(datos_o$club)[1:10]# así sacamos os 6 clubs o simplemente construyendo la lista
```
...
```{r}
tiro=fifa20_best_shooting$shooting
sueldo=fifa20_best_shooting$wage_eur
