...
El encargado de calidad piensa que el número de quejas de clientes por día en las oficinas de atención al cliente de una determinada zona de una ciudad sigue una ley $X$  $Po(\lambda=5)$. Para comprobarlo toma una muestra de $n=100$ días:
