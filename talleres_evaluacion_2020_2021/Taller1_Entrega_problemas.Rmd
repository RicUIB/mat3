...
Taller en grupo entregad las soluciones en .Rmd y .html o .pdf. o si lo escribidlas de forma manual y escanear el resultado, en un solo fichero.
...
1. Calcular la probabilidad que lleguen más de  10 peticiones en un 3 segundos.
...
2. Calcular la probabilidad de que el tiempo de ejecución sea  mayor que 130 para cada algoritmos.
...
1. ¿Cual  es el valor esperando y la varianza del número tiros hasta aceptar los 10 tiros libres?
